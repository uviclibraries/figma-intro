...
# 0) Figma Scavenger Hunt (5 minutes)

{: .note }
This is the “stop being scared of the interface” step. If you skip this, you’ll spend the next 30 minutes lost in zoom hell.

## Goal
In **5 minutes**, prove you can do the basic moves in Figma without hand-holding.
...
- You can zoom/pan and find your frame again.
- You have **at least one** working prototype link.

## If you get stuck (fast fixes)
- Lost your canvas? Use **Shift + 0** (Zoom to Fit).
- Can’t select an object? Check the **Layers** panel and click it there.
- Auto Layout “ruined” your layout? Good. That means it’s working. Undo once and reselect the correct parent group.
